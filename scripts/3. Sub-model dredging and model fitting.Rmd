...
The 750 meter spatial scale is best for natural variables. 
...
We need to remove roads or well because they are highly correlated. 
...
** not technically thre global model but the best fitting submodel
```{r}
...
Lets try all anthro edges as one variable and run that in an interaction model. 
