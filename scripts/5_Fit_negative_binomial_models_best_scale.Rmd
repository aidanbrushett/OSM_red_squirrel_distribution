...
ggsave(odds_fig_top, file = "./figures/top_model_neg_binomial_rate_ratios.png", width = 5, height = 3.5)
```
...
f_edge_cfi <- ggeffects::ggpredict(
  ...
  # OR JUST LABEL THEM AS QUANTILES 
    ...
    scale_fill_manual(
      values = c('dodgerblue2', 'darkred'),  # Fill colors for clarity
      labels = c("10% quantile", "90% quantile")
    ) +
    ...
    theme(
      ...
      plot.margin = margin(5, 5, 5, 5)           # Optional: adjust plot margins
    ) +
...
f_full_right <- cowplot::plot_grid(f_edge, f_cfi, ncol = 1, align = "v", axis = "lr")
...
ggsave(f_full, file = "./figures/top_model_all_effects.png", width = 9, height = 6, dpi = 500)
