...
```{r}
response <- read_csv("./data/processed/OSM_proportional_monthly_presence_2021_2022_2023.csv") %>%
  
  # remove data for the other species for now
  select(array, site, contains("squirrel"))
...
```{r}
write_csv(data, "./data/processed/OSM_proportional_monthly_presence_with_covariates_2021_2022_2023.csv")
```
