...
# remove the columns that we don't need and then combine some columns
# select the columns we need 

squirrels_all <- squirrels_all %>%
  select(array, site, red_squirrel, red_squirrel_absent, harvest, pipeline, roads, seismic_lines, 
         seismic_lines_3D, transmission_lines, wells, 
         lc_grassland, lc_coniferous, lc_broadleaf, lc_mixed, lc_shrub, osm_industrial)
