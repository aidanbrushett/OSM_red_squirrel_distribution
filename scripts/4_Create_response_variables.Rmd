...
This script is number 4 of 5 in a series of scripts used to replicate the analyses presented in the paper: "Life on the edge: Industrial footprint and edge effects variably affect the distribution of a boreal small mammal"
...
## 1.0. Import independent detection data

I (Aidan) processed independent detections in a separate script that I can provide if desired. Same goes for operating days. 

```{r}
# independent detections (30min).
...
## 1.1. Monthly independent detections and presence-absence
...
## 1.2. Monthly proportional presence-absence
...
## 1.3. Weekly independent detections and presence-absence
...
## 1.4. Weekly proportional presence-absence
...
## 3.2. Number of images and independent detections

Ideally this would have been checked in the past script where independent detections were calculated. Since we only need this for a quick and dirty reference to 
